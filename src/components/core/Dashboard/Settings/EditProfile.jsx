          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <input
                ...
                className="w-full rounded-[0.5rem] bg-richblack-800 border-2 p-[12px] text-richblack-5"
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <select
                ...
                name="gender"
                id="gender"
                className="w-full rounded-[0.5rem] bg-richblack-800 border-2 p-[15px] text-richblack-5"
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <input
                ...
                className="form-style w-full rounded-[0.5rem] bg-richblack-800 border-2 p-[12px] text-richblack-5"
