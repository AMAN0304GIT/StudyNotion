            ...
            <div className='max-w-[500px] p-4 lg:p-8'>
                ...
                <form action="" onSubmit={handleOnSubmit}>
                    <label htmlFor="" className="relative">
                        ...
                        <input type={showPassword ? "text": "password"} required name='password' value={password} onChange={handleOnChange} placeholder='Enter New Password' className="w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5"/>
                        <span
